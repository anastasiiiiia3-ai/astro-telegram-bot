    ...
    try:
        ...
        if service == "horary":
            ...
            await callback.message.answer(
                ...
                "Глубинный кармический анализ — узнайте своё истинное предназначение!\n\n"
                "<b>Вы узнаете:</b>\n\n"
                "💫 <b>Вашу духовную суть</b>\n"
                "Кто вы на самом деле на уровне души\n\n"
                "🧲 <b>Что притягивает в вашу жизнь</b>\n"
                "Почему к вам приходят определённые люди и события\n\n"
                "🤍 <b>Вашего ангела-хранителя</b>\n"
                "Откуда приходит защита и поддержка\n\n"
                "⭐ <b>Особые кармические дары</b>\n"
                "Таланты из прошлых жизней\n\n"
                "💰 <b>Где найти счастье и реализацию</b>\n"
                "Источники радости и духовного роста\n\n"
                "🌳 <b>Родовое наследие</b>\n"
                "Что передалось от предков и как с этим работать\n\n"
                "✨ <b>Ваше главное предназначение</b>\n"
                "Зачем ваша душа пришла в эту жизнь\n\n"
